...
public class CvSchoolManager implements CvSchoolService {
	...
	public DataResult<List<CvSchool>> getAll() {
		return new SuccessDataResult<List<CvSchool>>(this.cvSchoolDao.findAll(), "listed");
	}
	...
	@Override
	public DataResult<CvSchool> getById(int cvSchoolId) {
		return new SuccessDataResult<CvSchool>(this.cvSchoolDao.getOne(cvSchoolId));
	}
