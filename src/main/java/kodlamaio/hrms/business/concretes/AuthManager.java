...
public class AuthManager implements AuthService{
	...
	public Result registerCandidate(Candidate candidate) {
		...
		if (checkIfRealPerson(candidate.getFirstName(), candidate.getLastName(), 
				              candidate.getIdentityNumber(), candidate.getBirthOfYear()) == false){
	...
	private boolean checkIfRealPerson(String firstName, String lastName, String identityNumber, LocalDate birthOfYear) {
		if (userCheckService.checkIfRealPerson(firstName, lastName, identityNumber, birthOfYear)) {
			return true;
		}
		return false;
	}
